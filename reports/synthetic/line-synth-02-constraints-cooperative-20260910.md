# line-synth-02-constraints-cooperative-20260910 — line transcript (SYNTHETIC — in-process text simulation; no phone call, no CALL-E, no platform identifiers. Names are fictional.)
...
[00:29] CALLER: Hi, I'm Daniel Reyes, born September thirtieth, nineteen seventy‑eight. I'm calling because my left shoulder's been stiff and painful for about a month, especially when I reach overhead.
...
[00:34] CALLER: I actually was hoping to see Dr. Chen, if possible. Do you have any openings this Saturday around ten in the morning?
...
[00:40] CALLER: I appreciate it, but I can't make a nine‑o’clock slot. I work until three on weekdays, so any time after three would be better. Could you find the earliest weekday appointment after three?
...
[00:56] CALLER: Tuesday at three‑thirty with Dr. Reed works for me. Thank you, goodbye.
